...
namespace osg
{
	class IGCORE_EXPORT TBO
	{
	public:
		TBO(size_t width, OpenIG::Library::Graphics::DataFormat format, const osg::GLExtensions* ext, OpenIG::Library::Graphics::GPGPUDevice* pDevice);
		~TBO();
		...
		int bufferID(void) const {return _tboID;}
	private:
		bool _valid;
		...
		OpenIG::Library::Graphics::GPGPUDevice* m_pGPGPUDevice;
#if EXTRA_LOGGING
		FrameLogger _logger;
#endif
	};
