...
namespace igcore
{
     ...
     *  values on criteria used in the inherits. See \ref igcore::ImageGenerator::playAnimation
    ...
    public:
        ...
        struct Animation : public osg::Referenced
        {
            ...
            struct Sequence : public osg::Referenced
            {
                 ...
                 *  igcore::ImageGenerator::Entity this is the ID */
        ...
        /*! Plays simple animations. See \ref igcore::ImageGenerator::playAnimation .It calls this method
         *  on the \ref igcore::ImageGenerator .
         * \brief Plays simple animations. See \ref igcore::ImageGenerator::playAnimation
         * \param ig            The \ref igcore::ImageGenerator instance to call it for playback
         * \param entityId      The \ref igcore::ImageGenerator::Entity to play the animation on.
         *                      See \ref igcore::ImageGenerator::playAnimation
         * \param name          The name of the animation
         * \param cbs           Optional animation callbacks. See \ref igcore::AnimationSequencePlaybackCallback
         * \author    Trajce Nikolov Nick trajce.nikolov.nick@gmail.com
         * \copyright (c)Compro Computer Services, Inc.
         * \date      Sun Jan 11 2015
         */
        void playAnimation( igcore::ImageGenerator* ig, unsigned int entityId, const std::string& name, RefAnimationSequenceCallbacks* cbs = 0);

        /*! Stops the playback of simple animations. See \ref igcore::ImageGenerator::stopAnimation .It calls this method
         *  on the \ref igcore::ImageGenerator .
         * \brief Stops simple animations. See \ref igcore::ImageGenerator::stopAnimation
         * \param ig            The \ref igcore::ImageGenerator instance to call
         * \param entityId      The \ref igcore::ImageGenerator::Entity to stop the animation on.
         *                      See \ref igcore::ImageGenerator::stopAnimation
         * \param name          The name of the animation
         * \author    Trajce Nikolov Nick trajce.nikolov.nick@gmail.com
         * \copyright (c)Compro Computer Services, Inc.
         * \date      Mon May 18 2015
         */
        void stopAnimation( igcore::ImageGenerator* ig, unsigned int entityId, const std::string& name);

        /*! Reset a simple animations. See \ref igcore::ImageGenerator::resetAnimation .It calls this method
         *  on the \ref igcore::ImageGenerator .
         * \brief Plays simple animations. See \ref igcore::ImageGenerator::resetAnimation
         * \param ig            The \ref igcore::ImageGenerator instance to call
         * \param entityId      The \ref igcore::ImageGenerator::Entity to reset the animation on.
         *                      See \ref igcore::ImageGenerator::resetAnimation
         * \param name          The name of the animation
         * \author    Trajce Nikolov Nick trajce.nikolov.nick@gmail.com
         * \copyright (c)Compro Computer Services, Inc.
         * \date      Mon May 18 2015
         */
        void resetAnimation( igcore::ImageGenerator* ig, unsigned int entityId, const std::string& name);
         ...
         * \date      Sun Jan 11 2015
         */
        void updateAnimations(igcore::ImageGenerator* ig);
    ...
    protected:
        ...
        {
            RuntimeAnimation() : _startTime(0), _entityId(0) {}
