...
set( _osgComponents
    OpenThreads osg osgDB osgUtil osgGA osgText osgViewer osgShadow osgSim osgParticle osgAnimation
)
...
find_package( OpenSceneGraph 3.3.7 REQUIRED COMPONENTS ${_osgComponents} )
if( OSG_FOUND )
    foreach( currentLibIn ${_osgComponents} )
        string( TOUPPER ${currentLibIn} currentLib )
    ...
    set( OSG_LIBRARIES_DEBUG ${_tempLibrariesDebug} )
