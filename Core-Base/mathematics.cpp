...
//Code from Roni Zanolli roni@compro.net, originally used in a non-opensource Compro legacy Muse product
//Used with permission and modified slightly for use in OpenIG by Curtis Rubel crubel@compro.net
