    ...
    namespace Base {
        ...
        */
        ...
        struct CLoudLayerAttributes
        {
            ...
            void setEnable(bool enableIn = true)
            {
                enable = enableIn;
            }
            void setFlags(bool addIn = false, bool removeIn = false, bool enableFlagIn = false)
            {
                add = addIn;
                remove = removeIn;
        ...
        struct CLoudLayerFileAttributes
        {
            ...
            void setFlags(bool addIn = false, bool removeIn = false, bool enableIn = true)
            {
                add = addIn;
                remove = removeIn;
                enableFlag = enableIn;
