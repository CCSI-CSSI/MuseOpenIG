...
void BulletManager::setupVehicle(unsigned int id, OpenIG::Base::ImageGenerator::Entity& entity, const std::string& fileName)
{
...
void BulletManager::init(OpenIG::Base::ImageGenerator* ig, bool debug)
{
    _ig = ig;
    debug_mode = debug;
