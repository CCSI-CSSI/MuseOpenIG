...
public:
    ...
    */
     ...
     * \date      Tue Nov 8 2016
     */
    virtual void createCloudLayerFile(unsigned int id, int type, double altitude, double thickness=0, double density=0.3, bool enable=true, const std::string& filename="");
     ...
     */
    virtual void loadCloudLayerFile(unsigned int id, int type, const std::string& filename);
