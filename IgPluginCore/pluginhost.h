...
public:
     ...
     * orderd by ther order number. See \ref igplugincore::Plugin::getOrderNumber
     ...
     * \date      Fri Jan 16 2015
     */
    void applyPluginOperation(igplugincore::PluginOperation* operation);

    typedef std::map< int, osg::ref_ptr<igplugincore::Plugin> >                 PluginsMap;
    typedef std::map< int, osg::ref_ptr<igplugincore::Plugin> >::iterator       PluginsMapIterator;
    typedef std::map< int, osg::ref_ptr<igplugincore::Plugin> >::const_iterator PluginsMapConstIterator;
