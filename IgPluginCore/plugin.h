...
/*! The \ref openig::OpenIG Image Generator is designed with plugin-in based architecture
 ...
 * of inheritants chance to intercept in events happening in the \ref openig::OpenIG.
 * These events are the visual database or model loading, hooks in the DatabaseReadCallback,
 * in the \ref igcore::ImageGenerator::frame method for update and pre/post frame processing,
 * on \ref igcore::ImageGenerator::Entity addition.
 *
 * In \ref openig::OpenIG, a DatabaseReadCallback is implemented in a way that uses the
 ...
 * \endcode
 *
 * The other hooks are tied in \ref igcore::ImageGenerator::init to give
 ...
 * See \ref igcore::ImageGenerator::frame where these are explained
 *
 * And the last hook added is for the addEntity event, happens in
 * \ref igcore::ImageGenerator::addEntity
 *
...
public:
     ...
     * igcore::ImageGenerator::init. The file name is composed from the file name of
     ...
     *  See \ref igcore::ImageGenerator::frame for more info
     * \brief Update hook
     * \author    Trajce Nikolov Nick trajce.nikolov.nick@gmail.com
     * \copyright (c)Compro Computer Services, Inc.
     * \date      Fri Jan 16 2015
    ...
    /*! Hook called when \ref igcore::Entity is added to the scene. This
     * gives the user chance to intercept this event and perform actions
     * on the \ref igcore::Entity when it is added to the scene with
     * \ref igcore::ImageGenerator::addEntity
     * \brief Hook called when \ref igcore::Entity is added to the scene
     * \param the \ref igplugincore::PluginContext
     * \param the \ref igcore::ImageGenerator::Entity ID assigned
     * \param the osg::Node representing this \ref igcore::ImageGenerator::Entity
