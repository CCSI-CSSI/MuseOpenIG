...
namespace OpenIG {
	namespace Plugins {
		...
		protected:
			...
			void resizeTileLightGridOffsetAndSizeTBOIfNeeded(size_t numLights, const OpenIG::Library::Graphics::Vector2_uint32& viewPortSize, const OpenIG::Library::Graphics::Vector2_uint32& tileSize);
			void resizeTileLightIndexListTBOIfNeeded(size_t numLights, const OpenIG::Library::Graphics::Vector2_uint32& viewPortSize, const OpenIG::Library::Graphics::Vector2_uint32& tileSize);
