...
public:
    ...
    void createPages()
    {
       ...
       igcore::Commands::CommandsMapConstIterator itr = igcore::Commands::instance()->getCommands().begin();
       for ( ; itr != igcore::Commands::instance()->getCommands().end(); ++itr)
       {
